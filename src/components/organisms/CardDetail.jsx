...
const CardDetail = ({ astheroid }) => {
  ...
  const images = [astheroid1, astheroid2];
  ...
  return (
    <div className="cardDetail">
      ...
      <div className="astheroid-container">
        <img
          src={is_potentially_hazardous_asteroid ? astheroid3 : randomImage}
          alt="Astheroid"
        />
      </div>
      <div className="info-container">
        <CardInfo
          title="Información"
          description={`El asteroide ${name}, es uno de los asteroides que orbita nuestro sistema solar. Por lo cual ${
            is_potentially_hazardous_asteroid ? "" : "no"
          } lo hace de este asteroide peligroso para un impacto con el planeta tierra.`}
        />
        <div>
          <LabelCard
            title="¿Es peligroso?"
            description={is_potentially_hazardous_asteroid ? "Sí" : "No"}
          />
          <LabelCard
            title="Diametro Estimado Min"
            description={
              estimated_diameter_min
                ? `${estimated_diameter_min} km`
                : "421.520 km"
            }
          />
          <LabelCard
            title="Diametro Estimado Max"
            description={
              estimated_diameter_max
                ? `${estimated_diameter_max} km`
                : "421.520 km"
            }
          />
        </div>
        <Link to="/astheroids" className="button-primaryWhite">
          Regresar
        </Link>
      </div>
      <div className="info-container-bottom">
        ...
        <LabelCard
          ...
          description={
            absolute_magnitude_h ? `${absolute_magnitude_h}` : "21.520"
          }
        />
      </div>
    </div>
