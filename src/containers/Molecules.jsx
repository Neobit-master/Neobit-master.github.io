...
import {
  ...
  cardInfo,
  curosityFacts,
} from "@Components/manifests/blockContentManifes.json";
  ...
  return (
    <article className="systemContent">
      <div className="systemContent--information">
        ...
        <hr />
        <p>
          Las moleculas nos ayudaran a mantener una interacción activa con
          nuestros usuarios, son fundamentales para poder tener un sistema de
          diseño sostenible.
        </p>
        <nav>
          <ul>
            <li>
              <a href="/ds/molecules/#menu">Menu</a>
            </li>
            <li>
              <a href="/ds/molecules/#loading">Loading</a>
            </li>
            <li>
              <a href="/ds/molecules/#footer">Footer</a>
            </li>
            <li>
              <a href="/ds/molecules/#labelCard">Label Card</a>
            </li>
            <li>
              <a href="/ds/molecules/#blockContents">Block Contents</a>
            </li>
            <li>
              <a href="/ds/molecules/#hero">Hero</a>
            </li>
            <li>
              <a href="/ds/molecules/#card">Card</a>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <section id="menu" className="systemContent--section">
        ...
        <hr />
        <p>
          El menu es el conjunto de botones que van a ayudar al usuario a
          navegar por el sitio a sus diferentes secciones.
        </p>
      ...
      <section id="loading" className="systemContent--section">
        ...
        <hr />
        <p>
          El loading se usara cada vez que haya que avisar que el proceso
          realizado puede ser demorado.
        </p>
      ...
      <section id="footer" className="systemContent--section">
        ...
        <hr />
        <p>
          Está sección del sitio es el conocido footer que nos dará acceso a las
          redes sociales.
        </p>
      ...
      <section id="labelCard" className="systemContent--section">
        ...
        <hr />
        <p>
          Los labels son normalmente para dar el detalle de una característica
          de un elemento.
        </p>
        <div className="systemContent--section--components">
          <div className="container-component">
      ...
      <section id="blockContents" className="systemContent--section">
        ...
        <hr />
        <p>
          Estos son los bloques que van a permitir contener información
          relevante.
        </p>
      ...
      <section id="hero" className="systemContent--section">
        ...
        <hr />
        <p>
          Este elemento va a contar de que va el proyecto al usuario y empezar a
      ...
      <section id="card" className="systemContent--section">
        ...
        <hr />
        <p>
          Este elemento va ayudar al usuario a tener la percepción sobre que
          información va a querer ver a detalle.
        </p>
        <div className="systemContent--section--components">
          <div className="container-component">
